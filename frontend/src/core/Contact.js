            ...
            <div className="card my-4">
              <div className="card-header text-center bg-success">
                ...
                <p className="text-justify m-3 text-white">
                  Founded in 2020, Traveller for Life is Rwanda’s leading online
              ...
              <div className="card-body">
                <ul className="list-group">
                  ...
                  <li className="list-group-item">Traveller for Life Agency</li>
                  <li className="list-group-item ">Gorakhpur, Uttar Pradesh</li>
                  <li className="list-group-item">Rwanda, 274203</li>
                </ul>
              </div>
            </div>
          </div>
